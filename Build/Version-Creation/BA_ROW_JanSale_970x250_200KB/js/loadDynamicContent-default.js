...
(function () {
	...
	devDynamicContent[_feedName][0].Unique_ID = 40000;
	devDynamicContent[_feedName][0].Reporting_Label = "Default_970x250";
	...
	devDynamicContent[_feedName][0].showCopyDelays = "0,         0,         .5,        0,      .5,     1,      1,      .5,     .5,    .5,      .5,     0,    4.5,      .5,      .5,      .5,      	0";
												
												//   0:F1a_img, 1:F1b_img, 2:F1_icon, 3:F1_1, 4:F1_2, 5:F2_1, 6:F2_2, 7:F2_i, 8:F3_1  9:F3_2  10:F3_i 11:Fe_1 12:Fe_2   13:F4_1, 14:F4_2  15:F4_p  16:cta
	devDynamicContent[_feedName][0].copyAnimTypes = "10,        11,  	   12,     	  f,      f,      f,      f,      f,      f,      f,      f,      f,        f,       f,		 f,		  f,       f";
	...
	devDynamicContent[_feedName][0].img_logo_ba_01.Url = "images/logo_BA_970x250_x2.png";
	...
	devDynamicContent[_feedName][0].loopingProps = "0,4,false";
	devDynamicContent[_feedName][0].css_overrides = "#frame04_copy02, #frame03_copy01, .copy_price {color:#6db8e7;} #frame04_copy02{top: 198px;left: -3px;font-size: 28px;line-height: 30px;letter-spacing: 4px;} .copy_divider{left:-4px} #copy_frame04_package { top: 0; text-align: center; width: 300px; left: 0; font-size: 13px; line-height: 1.2em; } #copy_frame04_price { top: 43px; left: 113px; } #copy_frame04_pp { top: 73px; left: 195px; font-size: 9px; } #copy_frame04_currency { top: 55px; left: 87px; } #copy_frame04_ider { top: 50px; } #copy_frame04_from { top: 49px; left: 87px;} #frame04_price { left: 0; width: 300px; top: 306px;} #endframe_copy01 {left: 365px;top: 130px;}#logo_ba_01{left: -360px;top: -30px;} #cta {left:402px}";
