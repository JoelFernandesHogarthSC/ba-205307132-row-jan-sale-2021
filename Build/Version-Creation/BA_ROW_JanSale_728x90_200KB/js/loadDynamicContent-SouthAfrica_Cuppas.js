...
(function () {
	...
	devDynamicContent[_feedName][0].frame01a_img.Url = "../_assets/img_cuppas_282x78_x2.jpg";
	devDynamicContent[_feedName][0].frame01b_img = {};
	devDynamicContent[_feedName][0].frame01b_img.Type = "file";
	devDynamicContent[_feedName][0].frame01b_img.Url = "../_assets/img_lunches_282x78_x2.jpg";
	...
	devDynamicContent[_feedName][0].css_overrides = "#frame04_copy01, #frame03_copy02, #frame03_copy01 {color:#ce210f;} #frame01_copy01{left:252px;text-align:left;letter-spacing:1.4px;font-size:9px;top:6px} #frame01_copy02 { left: -299px; letter-spacing: 3.4px; text-align:right; width:570px; font-size:18px; top:25px;} #frame01_copy02 div { left: 610px; letter-spacing: 3.9px; text-align:left; } #frame01_copy01,#frame01_copy02{text-shadow:0 0 4px rgba(0,0,0,0.3)} #frame03_copy01{font-size:11px;letter-spacing:.15em;top:-4px;left:-76px;line-height:36px} #frame03_copy01b { position: relative; left: 41px; } #frame03_copy02{width:688px;left:-95px;font-size:24px;letter-spacing:.16em;top:35px!important} #frame04_copy01, #frame04_copy02 { top: 75px; letter-spacing: 3.5px; font-size: 28px; line-height: 33px; left: 22px; width: 290px; } #frame04_copy02{left:70px;font-size:9px;width:504px;top:186px;letter-spacing:.185em} #frame04_copy02b{font-size:10px;top:31px;position:absolute;left:285px;letter-spacing:.225em} #frame04_copy02a1{position:absolute;left:233px} #frame04_copy02a2{position:absolute; left:409px} #cta{top:42px;left:610px;transform:scale(1.1)!important;width:82px} #cta_copy{line-height:24px;text-indent:1px} #cta_bg{border-color:#ce210f;} .ctaCopy { color:#ce210f;} #container:active #cta_bg,#container:hover #cta_bg{background:#ce210f!important;border:1px solid #ce210f!important;} .termsCopy { right: 8px; bottom: 6px; left: auto; text-align: right; } #frame01a_img_container,#frame01b_img_container{width:282px;height:78px;left:288px;top:6px} #frame01a_img_container{left:6px} #frame01_icon{left:279px;top:26px} #frame01_icon.animateOff_F3{opacity:1!important} #frame01.animateOff{transition:opacity .5s 0s} #frame04_copy01{left:100px;width:644px;letter-spacing:.19em;top:29px;font-size:23px;text-align:left} #frame04_copy01 div{position:absolute;top:0;left:215px} #frame03_copy01 div{left:14px!important;} sup{font-size:unset;vertical-align:unset;line-height:unset}";
