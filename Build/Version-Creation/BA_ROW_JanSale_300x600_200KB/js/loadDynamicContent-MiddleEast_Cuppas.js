...
(function () {
	...
	devDynamicContent[_feedName][0].Unique_ID = 20001;
	devDynamicContent[_feedName][0].Reporting_Label = "Middle_East_Cuppas_Lunches_300x600";
	...
	devDynamicContent[_feedName][0].frame01a_img.Url = "../_assets/img_cuppas_262x246_x2.jpg";
	devDynamicContent[_feedName][0].frame01b_img = {};
	devDynamicContent[_feedName][0].frame01b_img.Type = "file";
	devDynamicContent[_feedName][0].frame01b_img.Url = "../_assets/img_lunches_262x243_x2.jpg";
	...
	devDynamicContent[_feedName][0].css_overrides = "#frame04_copy01, #frame04_copy02, #frame03_copy01 {color:#1255a3;} #frame01_copy01 { top: 167px; left: 0; letter-spacing: 2.7px; font-size: 15px; line-height: 17px; } #frame01_copy02{top:196px;letter-spacing:5px; line-height:33px;} #frame01_copy02 div {margin-top:121px;} #frame01_copy01,#frame01_copy02{text-shadow:0 0 8px rgba(0,0,0,0.3)} #frame03_copy01{top:73px;left:1px}#frame03_copy01 div{margin:120px 0 0 2px} #frame04_copy01, #frame04_copy02 { top: 201px; left: 2px; font-size: 28px; line-height: 29px; letter-spacing: 4.6px; } #frame04_copy02 { top: 383px; } #cta { top: 482px; } .copy_divider{opacity:0} #frame01_icon.animateOff_F3{opacity:1!important} #frame01a_img_container,#frame01b_img_container{width:262px;height:243px;top:326px;} #frame01a_img_container{top:80px;height:246px} #frame01.animateOff{transition:opacity .5s 0s} .termsCopy { left:unset; right: 0px!important; margin-right:10px; text-align:right;  }  #frame03_copy02{top:474px;} " ;
