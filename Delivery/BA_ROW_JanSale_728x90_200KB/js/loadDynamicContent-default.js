...
(function() {
	...
	devDynamicContent[_feedName][0].Reporting_Label = "RoofTops_CliffTops_728x90_DE";
	...
	devDynamicContent[_feedName][0].frame01a_img.Url = "images/img_rooftops_282x78_x2.jpg";
	devDynamicContent[_feedName][0].frame01b_img = {};
	devDynamicContent[_feedName][0].frame01b_img.Type = "file";
	devDynamicContent[_feedName][0].frame01b_img.Url = "images/img_clifftops_282x78_x2.jpg";
	...
	devDynamicContent[_feedName][0].frame01_icon.Url = "images/ampersand_728x90_x2.gif";
	devDynamicContent[_feedName][0].frame01_frame = {};
	devDynamicContent[_feedName][0].frame01_frame.Type = "file";
	devDynamicContent[_feedName][0].frame01_frame.Url = "images/img_frame_Jansale2021_728x90.png";
	...
	devDynamicContent[_feedName][0].frame03_copy01 = "BOOK NOW<div>CHANGE LATER</div>";
	...
	devDynamicContent[_feedName][0].frame04_copy02 = "UP TO 20%<br>OFF HOLIDAYS";
	...
	// devDynamicContent[_feedName][0].frameTimes = "0.5,0,0.5";
	...
	devDynamicContent[_feedName][0].img_logo_ba_01.Url = "images/logo_BA_Jansale2021_728x90_x2.png";
	...
	devDynamicContent[_feedName][0].img_logo_partners.Url = "images/logo_BA_partners_noATOL_728x90_x2.png";
	...
	devDynamicContent[_feedName][0].img_replayBtn.Url = "images/btnReplay_x2.png";
